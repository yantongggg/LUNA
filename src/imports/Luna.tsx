import svgPaths from "./svg-sicxtwzs1g";

function Container2() {
  return <div className="absolute h-[1024px] left-[-0.5px] top-0 w-[405px]" data-name="Container" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 408 1024\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(0 -87.036 -90.588 0 102 204.8)\\'><stop stop-color=\\'rgba(255,220,230,0.6)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(191,165,173,0.45)\\' offset=\\'0.15\\'/><stop stop-color=\\'rgba(128,110,115,0.3)\\' offset=\\'0.3\\'/><stop stop-color=\\'rgba(64,55,58,0.15)\\' offset=\\'0.45\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'0.6\\'/></radialGradient></defs></svg>'), url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 408 1024\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(0 -77.475 -80.637 0 306 307.2)\\'><stop stop-color=\\'rgba(230,210,240,0.5)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(173,158,180,0.375)\\' offset=\\'0.15\\'/><stop stop-color=\\'rgba(115,105,120,0.25)\\' offset=\\'0.3\\'/><stop stop-color=\\'rgba(58,53,60,0.125)\\' offset=\\'0.45\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'0.6\\'/></radialGradient></defs></svg>'), url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 408 1024\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(0 -74.311 -77.345 0 204 716.8)\\'><stop stop-color=\\'rgba(200,240,220,0.4)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(150,180,165,0.3)\\' offset=\\'0.15\\'/><stop stop-color=\\'rgba(100,120,110,0.2)\\' offset=\\'0.3\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'0.6\\'/></radialGradient></defs></svg>'), linear-gradient(111.724deg, rgb(255, 232, 240) 0%, rgb(248, 240, 251) 50%, rgb(240, 250, 245) 100%)" }} />;
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[29.304px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29.3043 29.3043">
        <g clipPath="url(#clip0_99_726)" id="Icon">
          <path d={svgPaths.p19b052f0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.95" strokeWidth="2.19782" />
          <path d="M14.6521 12.2101V17.0942" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.95" strokeWidth="2.44202" />
        </g>
        <defs>
          <clipPath id="clip0_99_726">
            <rect fill="white" height="29.3043" width="29.3043" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Container11() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-1.49px] rounded-[16777200px] shadow-[0px_7.863px_31.453px_0px_rgba(194,167,184,0.44)] size-[66.981px] top-[-1.49px]" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(159, 183, 164) 0%, rgb(214, 180, 184) 70%, rgb(232, 200, 204) 100%)" }}>
      <Icon1 />
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_2px_6px_0px_rgba(255,255,255,0.59)]" />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[866px] items-start left-0 px-[24px] top-[158px] w-[389px]" data-name="Container">
      <Container6 />
      <Container12 />
      <Container19 />
      <Container26 />
...
function SecureDashboard() {
  return (
    <div className="h-[1024px] overflow-clip relative shrink-0 w-[405px]" data-name="SecureDashboard">
      <Container2 />
      <Container3 />
      <Container5 />
    </div>
...
export default function Luna() {
  return (
    <div className="bg-[#faf8f6] content-stretch flex flex-col items-start relative size-full" data-name="LUNA">
      <App />
    </div>
  );
}