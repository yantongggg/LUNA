import svgPaths from "./svg-sru39y4ri6";
...
function App() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[964px] left-0 top-0 w-[927px]" data-name="App">
      <Container />
    </div>
  );
}
...
export default function PrivacySecurityAppDesign() {
  return (
    <div className="bg-[#faf8f6] relative size-full" data-name="Privacy Security App Design">
      <App />
    </div>
  );
}